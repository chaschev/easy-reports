...
* Date: 6/21/13
*/
public class PhraseBuilder  extends ElementBuilder<Phrase, PhraseBuilder> {
    ...
    public PhraseBuilder newPhrase(){
        element = new Phrase();
        return this;
    }

    public PhraseBuilder newPhrase(String text, String cssStyleString){
        element = new Phrase(text);

        return styles(cssStyleString);
    }
    ...
    public PhraseBuilder add(Element element) {
    ...
    public PhraseBuilder setLeading(float leading) {
